...
$ubicacion = array('img/art/1.png', 'img/art/2.jpg', 'img/art/3.jpg', 'img/art/4.jpg', 'img/art/5.jpg', 'img/art/6.jpeg', 'img/art/7.jpeg', 'img/art/8.jpg');

try {
    $query = 'SELECT IDArticulo,Nombre,Precio,Disponibles FROM Articulo';
...
<html lang="en">
    <head>
        ...
        <title>Articulos turisticos</title>
    </head>
    <body style="margin-top:80px">
        ...
        <main class="container">
            <div class="jumbotron jumbotron-fluid">'
                <h3 class="container text-center">¡Recuerda por siempre tu experiencia en Campeche con uno de nuestros articulos!</h3>
            </div>
            <div class="card-columns">
                <?php
                for ($i = 0; $i < count($ubicacion); $i++) {
                    echo '<div class="card" style="height:38em;;">';
                        ...
                        echo '<div class="card-body">';
                            ...
                            echo '<a href="comprarArticulo.php?idart='.$result[$i]['IDArticulo'].'&img='.$ubicacion[$i].'" class="btn btn-primary stretched-link">Comprar</a>';
                        echo '</div>';
                    echo '</div>';
                }
                ?>
